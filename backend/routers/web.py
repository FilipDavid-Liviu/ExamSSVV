...
def get_farm_service(request: Request) -> FarmService:
    return request.app.state.farm_service

@router.get("/", response_class=HTMLResponse)
async def read_dashboard(request: Request, service: FarmService = Depends(get_farm_service)):
...
async def list_fields(request: Request, service: FarmService = Depends(get_farm_service)):
...
async def edit_field_form(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
...
async def delete_field(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
...
async def list_crops(request: Request, service: FarmService = Depends(get_farm_service)):
...
async def edit_crop_form(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
...
async def delete_crop(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
...
async def list_harvests(request: Request, service: FarmService = Depends(get_farm_service)):
...
async def new_harvest_form(request: Request, service: FarmService = Depends(get_farm_service)):
    fields = service.list_fields()
    crops = service.list_crops()
...
async def edit_harvest_form(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
...
async def delete_harvest(request: Request, id: int, service: FarmService = Depends(get_farm_service)):
